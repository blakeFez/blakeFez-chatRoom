...
Showbo.Msg={  
    ...
    InitMsg:function(width){  
      ...
      html='<div class="top"><div class="right"><div class="title" id="dvMsgTitle">提示</div></div></div>'+  
        '<div class="body"><div class="right"><div class="ct" id="dvMsgCT"></div></div></div>'+  
        '<div class="bottom" id="dvMsgBottom" style="height: 55px;"><div class="right"><div class="butn" id="dvMsgBtns"></div></div></div>';  
    ...
    createBtn:function(p,v,fn){  
        ...
        btn.onmouseout=function(){this.className='butn';}  
    ...
    alert:function(msg){  
		this.show({buttons:{yes:'确认'},msg:msg,title:'提示'});
    },  
    confirm:function(msg,fn,mthis){  
      //fn为回调函数，参数和show方法的一致
	  deleteid = $(mthis).parent().parent().attr('alt');
	  tempthis = mthis;
